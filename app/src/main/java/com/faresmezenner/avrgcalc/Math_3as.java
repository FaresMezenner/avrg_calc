...
public class Math_3as extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Math_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Math_3as.this).inflate(R.layout.save_before, viewGroup, false);
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.math_3as);
    ...
    AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Math_3as.this,R.style.CustomAlertDialog);
    ViewGroup viewGroup2 = findViewById(android.R.id.content);
    View dialogView2 = LayoutInflater.from(Math_3as.this).inflate(R.layout.repport_science, viewGroup2, false);
    ...
    LinearLayout kabyle_layout2 = dialogView2.findViewById(R.id.kabyle_layout);
        ...
        SharedPreferences prefs = getSharedPreferences("math_3as", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Math_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Math_3as.this).inflate(R.layout.fill_all, viewGroup, false);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("math_3as", MODE_PRIVATE);
