...
public class Bac_languages extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_languages.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_languages.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bac_languages);
        ...
        SharedPreferences prefs = getSharedPreferences("bac_languages", MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();


        EditText[] note = new EditText[10];
        ...
        note[6] = findViewById(R.id.exam_language);
        note[7] = findViewById(R.id.exam_math);
        note[8] = findViewById(R.id.exam_sport);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Bac_languages.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Bac_languages.this).inflate(R.layout.repport_bac, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_languages.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_languages.this).inflate(R.layout.fill_all, viewGroup, false);
