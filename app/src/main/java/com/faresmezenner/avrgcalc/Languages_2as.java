...
public class Languages_2as extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Languages_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Languages_2as.this).inflate(R.layout.save_before, viewGroup, false);
   ...
   @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.languages_2as);
       ...
       AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Languages_2as.this,R.style.CustomAlertDialog);
       ViewGroup viewGroup2 = findViewById(android.R.id.content);
       View dialogView2 = LayoutInflater.from(Languages_2as.this).inflate(R.layout.repport_languages, viewGroup2, false);
       ...
       LinearLayout kabyle_layout2 = dialogView2.findViewById(R.id.kabyle_layout);
        ...
        String[] checkboxs_keys = new String[9];


        EditText[] test2 = new EditText[9];
        EditText[] exam = new EditText[9];
        EditText[] test1 = new EditText[9];
        EditText[] application = new EditText[9];
        EditText[] ta9wim = new EditText[9];


        checkboxs[0] = findViewById(R.id.test2_arabic_checkbox);
        checkboxs[1] = findViewById(R.id.test2_history_checkbox);
        checkboxs[2] = findViewById(R.id.test2_islamia_checkbox);
        checkboxs[3] = findViewById(R.id.test2_french_checkbox);
        checkboxs[4] = findViewById(R.id.test2_english_checkbox);
        checkboxs[5] = findViewById(R.id.test2_language_checkbox);
        checkboxs[6] = findViewById(R.id.test2_math_checkbox);
        checkboxs[7] = findViewById(R.id.test2_sport_checkbox);
        checkboxs[8] = findViewById(R.id.test2_kabyle_checkbox);



        checkboxs_keys[0] = "test2_arabic";
        checkboxs_keys[1] = "test2_history";
        checkboxs_keys[2] = "test2_islamia";
        checkboxs_keys[3] = "test2_french";
        checkboxs_keys[4] = "test2_english";
        checkboxs_keys[5] = "test2_language";
        checkboxs_keys[6] = "test2_math";
        checkboxs_keys[7] = "test2_sport";
        checkboxs_keys[8] = "test2_kabyle";


        exam[0] = findViewById(R.id.exam_arabic);
        exam[1] = findViewById(R.id.exam_history);
        exam[2] = findViewById(R.id.exam_islamia);
        exam[3] = findViewById(R.id.exam_french);
        exam[4] = findViewById(R.id.exam_english);
        exam[5] = findViewById(R.id.exam_language);
        exam[6] = findViewById(R.id.exam_math);
        exam[7] = findViewById(R.id.exam_sport);
        exam[8] = findViewById(R.id.exam_kabyle);


        test2[0] = findViewById(R.id.test2_arabic);
        test2[1] = findViewById(R.id.test2_history);
        test2[2] = findViewById(R.id.test2_islamia);
        test2[3] = findViewById(R.id.test2_french);
        test2[4] = findViewById(R.id.test2_english);
        test2[5] = findViewById(R.id.test2_language);
        test2[6] = findViewById(R.id.test2_math);
        test2[7] = findViewById(R.id.test2_sport);
        test2[8] = findViewById(R.id.test2_kabyle);


        test1[0] = findViewById(R.id.test1_arabic);
        test1[1] = findViewById(R.id.test1_history);
        test1[2] = findViewById(R.id.test1_islamia);
        test1[3] = findViewById(R.id.test1_french);
        test1[4] = findViewById(R.id.test1_english);
        test1[5] = findViewById(R.id.test1_language);
        test1[6] = findViewById(R.id.test1_math);
        test1[7] = findViewById(R.id.test1_sport);
        test1[8] = findViewById(R.id.test1_kabyle);


        application[0] = findViewById(R.id.application_arabic);
        application[1] = null;
        application[2] = null;
        application[3] = findViewById(R.id.application_french);
        application[4] = findViewById(R.id.application_english);
        application[5] = findViewById(R.id.application_language);
        application[6] = null;
        application[7] = null;
        application[8] = null;
        ...
        ta9wim[1] = findViewById(R.id.ta9wim_history);
        ta9wim[2] = findViewById(R.id.ta9wim_islamia);
        ta9wim[3] = findViewById(R.id.ta9wim_french);
        ta9wim[4] = findViewById(R.id.ta9wim_english);
        ta9wim[5] = findViewById(R.id.ta9wim_language);
        ta9wim[6] = findViewById(R.id.ta9wim_math);
        ta9wim[7] = findViewById(R.id.ta9wim_sport);
        ta9wim[8] = findViewById(R.id.ta9wim_kabyle);
        ...
        SharedPreferences prefs = getSharedPreferences("language_2as", MODE_PRIVATE);
        ...
        avrgs_show[1] = dialogView2.findViewById(R.id.islamia_avrg);
        avrgs_show[2] = dialogView2.findViewById(R.id.history_avrg);
        avrgs_show[3] = dialogView2.findViewById(R.id.french_avrg);
        avrgs_show[4] = dialogView2.findViewById(R.id.english_avrg);
        avrgs_show[5] = dialogView2.findViewById(R.id.language_avrg);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Languages_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Languages_2as.this).inflate(R.layout.fill_all, viewGroup, false);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("language_2as", MODE_PRIVATE);
