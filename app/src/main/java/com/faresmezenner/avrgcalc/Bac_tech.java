...
public class Bac_tech extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_tech.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_tech.this).inflate(R.layout.save_before, viewGroup, false);
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bac_tech);
        ...
        note[3] = findViewById(R.id.exam_tech);
        ...
        SharedPreferences prefs = getSharedPreferences("bac_tech", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Bac_tech.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
            View dialogView2 = LayoutInflater.from(Bac_tech.this).inflate(R.layout.repport_bac, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_tech.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_tech.this).inflate(R.layout.fill_all, viewGroup, false);
