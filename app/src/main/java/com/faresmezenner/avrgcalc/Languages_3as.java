...
public class Languages_3as extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Languages_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Languages_3as.this).inflate(R.layout.save_before, viewGroup, false);
  ...
  @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.languages_3as);
      ...
      LinearLayout kabyle_layout2 = dialogView2.findViewById(R.id.kabyle_layout);
        ...
        checkboxs[6] = findViewById(R.id.test2_language_checkbox);
        checkboxs[7] = findViewById(R.id.test2_math_checkbox);
        ...
        checkboxs_keys[6] = "test2_language";
        checkboxs_keys[7] = "test2_math";
        ...
        exam[6] = findViewById(R.id.exam_language);
        exam[7] = findViewById(R.id.exam_math);
        ...
        test2[6] = findViewById(R.id.test2_language);
        test2[7] = findViewById(R.id.test2_math);
        ...
        test1[6] = findViewById(R.id.test1_language);
        test1[7] = findViewById(R.id.test1_math);
        ...
        application[2] = null;
        application[3] = null;
        application[4] = findViewById(R.id.application_french);
        application[5] = findViewById(R.id.application_english);
        application[6] = findViewById(R.id.application_language);
        application[7] = null;
        application[8] = null;
        application[9] = null;
        ...
        ta9wim[6] = findViewById(R.id.ta9wim_language);
        ta9wim[7] = findViewById(R.id.ta9wim_math);
        ...
        SharedPreferences prefs = getSharedPreferences("language_3as", MODE_PRIVATE);
        ...
        avrgs_show[6] = dialogView2.findViewById(R.id.language_avrg);
        avrgs_show[7] = dialogView2.findViewById(R.id.math_avrg);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Languages_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Languages_3as.this).inflate(R.layout.fill_all, viewGroup, false);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("language_3as", MODE_PRIVATE);
