...
public class Science_jd extends AppCompatActivity {


    static int MATH = 5;
    static int SCIENCE = 4;
    static int PHYSIC = 4;
    static int TECH = 2;
    static int INFORMATIQUE = 2;
    static int ARABIC = 3;
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Science_jd.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Science_jd.this).inflate(R.layout.save_before, viewGroup, false);
        ...
        Intent backIntent = new Intent(getApplicationContext(), Branchs_jd.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkboxs[8] = findViewById(R.id.test2_informatique_checkbox);
        checkboxs[9] = findViewById(R.id.test2_tech_checkbox);
        ...
        checkboxs_keys[8] = "test2_informatique";
        checkboxs_keys[9] = "test2_tech";
        ...
        exam[8] = findViewById(R.id.exam_informatique);
        exam[9] = findViewById(R.id.exam_tech);
        ...
        test2[8] = findViewById(R.id.test2_informatique);
        test2[9] = findViewById(R.id.test2_tech);
        ...
        test1[8] = findViewById(R.id.test1_informatique);
        test1[9] = findViewById(R.id.test1_tech);
        ...
        application[1] = null;
        application[2] = findViewById(R.id.application_physic);
        application[3] = findViewById(R.id.application_science);
        application[4] = null;
        application[5] = null;
        application[6] = findViewById(R.id.application_french);
        application[7] = findViewById(R.id.application_english);
        application[8] = findViewById(R.id.application_informatique);
        application[9] = findViewById(R.id.application_tech);
        application[10] = null;
        application[11] = null;
        ...
        ta9wim[8] = findViewById(R.id.ta9wim_informatique);
        ta9wim[9] = findViewById(R.id.ta9wim_tech);
        ...
        SharedPreferences prefs = getSharedPreferences("science_jd", MODE_PRIVATE);
...

        {
            ...
            }
            {
                ...
                application[6].setOnFocusChangeListener(onFocusChangeListener);
                application[7].setOnFocusChangeListener(onFocusChangeListener);
                application[8].setOnFocusChangeListener(onFocusChangeListener);
                application[9].setOnFocusChangeListener(onFocusChangeListener);
            }
            {
        ...
        if(prefs.getBoolean("kabyle", false)){
            ...
            ta9wim[11].setVisibility(View.VISIBLE);
            ...
            ta9wim[11].setVisibility(View.GONE);
        ...
        if(prefs.getBoolean("sport", true)){
            ...
            ta9wim[10].setVisibility(View.VISIBLE);
            ...
            ta9wim[10].setVisibility(View.GONE);
        ...
        avrgs_show[8] = dialogView2.findViewById(R.id.informatique_avrg);
        avrgs_show[9] = dialogView2.findViewById(R.id.tech_avrg);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Science_jd.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Science_jd.this).inflate(R.layout.fill_all, viewGroup, false);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i<SUBJECTS; i++){
                    ...
                    if(!(application[i] == null)){
                        ...
                        if(!TextUtils.isEmpty(application[i].getText().toString())){
                            ...
                            Log.d("d","d");
                            alerdialog.show();
                            SUBJECTS = 12; success = false; break;
                ...
                ta9wim[11].setText(ta9wim_kabyle);
                test1[11].setText(test1_kabyle);
                if (checkboxs[11].isChecked()) {

                    test2[11].setText(test2_kabyle);

                } else {

                    test2[11].setText("-/-");
                }
                exam[11].setText(exam_kabyle);


                ta9wim[10].setText(ta9wim_sport);
                test1[10].setText(test1_sport);
                if (checkboxs[10].isChecked()) {

                    test2[10].setText(test2_sport);

                } else {

                    test2[10].setText("-/-");
                }
                exam[10].setText(exam_sport);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("science_jd", MODE_PRIVATE);
