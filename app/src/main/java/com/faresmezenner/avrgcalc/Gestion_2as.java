...
public class Gestion_2as extends AppCompatActivity {


    static int ARABIC = 2;
    static int MATH = 3;
    static int ACCOUNTING = 5;
    static int GESTION = 4;
    static int LAW = 2;
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Gestion_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Gestion_2as.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gestion_2as);
        ...
        SharedPreferences prefs = getSharedPreferences("gestion_2as", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Gestion_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Gestion_2as.this).inflate(R.layout.repport_gestion, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Gestion_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Gestion_2as.this).inflate(R.layout.fill_all, viewGroup, false);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("gestion_2as", MODE_PRIVATE);
