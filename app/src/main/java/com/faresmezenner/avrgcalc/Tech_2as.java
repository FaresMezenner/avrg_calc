...
public class Tech_2as extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Tech_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Tech_2as.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] checkboxs_keys = new String[10];
        
        
        EditText[] exam = new EditText[10];
        EditText[] test2 = new EditText[10];
        EditText[] test1 = new EditText[10];
        EditText[] application = new EditText[10];
        EditText[] ta9wim = new EditText[10];
        ...
        checkboxs[3] = findViewById(R.id.test2_tech_checkbox);
        ...
        checkboxs[8] = findViewById(R.id.test2_sport_checkbox);
        checkboxs[9] = findViewById(R.id.test2_kabyle_checkbox);
        ...
        exam[3] = findViewById(R.id.exam_tech);
        ...
        exam[8] = findViewById(R.id.exam_sport);
        exam[9] = findViewById(R.id.exam_kabyle);
        ...
        test2[3] = findViewById(R.id.test2_tech);
        ...
        test2[8] = findViewById(R.id.test2_sport);
        test2[9] = findViewById(R.id.test2_kabyle);
        ...
        test1[3] = findViewById(R.id.test1_tech);
        ...
        test1[8] = findViewById(R.id.test1_sport);
        test1[9] = findViewById(R.id.test1_kabyle);
        ...
        application[3] = findViewById(R.id.application_tech);
        application[4] = null;
        application[5] = null;
        ...
        ta9wim[3] = findViewById(R.id.ta9wim_tech);
        ...
        ta9wim[8] = findViewById(R.id.ta9wim_sport);
        ta9wim[9] = findViewById(R.id.ta9wim_kabyle);
        ...
        SharedPreferences prefs = getSharedPreferences("tech_2as", MODE_PRIVATE);
        ...
        if(prefs.getBoolean("kabyle", false)){
            ...
            ta9wim[9].setVisibility(View.VISIBLE);
            ...
            ta9wim[9].setVisibility(View.GONE);
        ...
        if(prefs.getBoolean("sport", true)){
            ...
            ta9wim[8].setVisibility(View.VISIBLE);
            ...
            ta9wim[8].setVisibility(View.GONE);
        ...
        avrgs_show[3] = dialogView2.findViewById(R.id.tech_avrg);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Tech_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Tech_2as.this).inflate(R.layout.fill_all, viewGroup, false);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ta9wim[9].setText(ta9wim_kabyle);
                test1[9].setText(test1_kabyle);
                if (checkboxs[9].isChecked()) {

                    test2[9].setText(test2_kabyle);

                } else {

                    test2[9].setText("-/-");
                }
                exam[9].setText(exam_kabyle);


                ta9wim[8].setText(ta9wim_sport);
                test1[8].setText(test1_sport);
                if (checkboxs[8].isChecked()) {

                    test2[8].setText(test2_sport);

                } else {

                    test2[8].setText("-/-");
                }
                exam[8].setText(exam_sport);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("tech_3as", MODE_PRIVATE);
