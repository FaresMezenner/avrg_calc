...
public class Math_2as extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Math_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Math_2as.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.math_2as);
        ...
        SharedPreferences prefs = getSharedPreferences("math_2as", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Math_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Math_2as.this).inflate(R.layout.fill_all, viewGroup, false);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("math_2as", MODE_PRIVATE);
