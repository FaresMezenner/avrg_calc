...
public class Science_2as extends AppCompatActivity {
    ...
    public void onBackPressed() {
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Science_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Science_2as.this).inflate(R.layout.save_before, viewGroup, false);
...
@Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.science_2as);
    ...
    AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Science_2as.this,R.style.CustomAlertDialog);
    ViewGroup viewGroup2 = findViewById(android.R.id.content);
    View dialogView2 = LayoutInflater.from(Science_2as.this).inflate(R.layout.repport_science, viewGroup2, false);
    ...
    LinearLayout kabyle_layout2 = dialogView2.findViewById(R.id.kabyle_layout);
        ...
        SharedPreferences prefs = getSharedPreferences("science_2as", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Science_2as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Science_2as.this).inflate(R.layout.fill_all, viewGroup, false);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
...

                {
                    ...
                    if (!lasts[1].getText().toString().isEmpty()  && !lasts[0].getText().toString().equals(".")) {
                        if (Double.valueOf(lasts[1].getText().toString()) > 20 || Double.valueOf(lasts[1].getText().toString()) < 0) {
                            lasts[1].setTextColor(getResources().getColor(R.color.red));
                            lasts[1].setBackgroundResource(R.drawable.button_border_red);
                            toast.show();
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("science_2as", MODE_PRIVATE);
