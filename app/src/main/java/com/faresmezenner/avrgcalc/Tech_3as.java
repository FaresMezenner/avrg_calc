...
public class Tech_3as extends AppCompatActivity  {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Tech_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Tech_3as.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tech_3as);
        ...
        SharedPreferences prefs = getSharedPreferences("tech_3as", MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();




        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Tech_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Tech_3as.this).inflate(R.layout.repport_tech, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Tech_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Tech_3as.this).inflate(R.layout.fill_all, viewGroup, false);
