...
public class Science_3as extends AppCompatActivity {


    static int MATH = 5;
    static int SCIENCE = 6;
    static int PHYSIC = 5;
    static int ARABIC = 3;
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Science_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Science_3as.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.science_3as);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Science_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Science_3as.this).inflate(R.layout.repport_science, viewGroup2, false);
        ...
        checkboxs[8] = findViewById(R.id.test2_philo_checkbox);
        ...
        exam[8] = findViewById(R.id.exam_philo);
        ...
        test2[8] = findViewById(R.id.test2_philo);
        ...
        test1[8] = findViewById(R.id.test1_philo);
        ...
        ta9wim[8] = findViewById(R.id.ta9wim_philo);
        ...
        SharedPreferences prefs = getSharedPreferences("science_3as", MODE_PRIVATE);
        ...
        avrgs_show[8] = dialogView2.findViewById(R.id.philo_avrg);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Science_3as.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Science_3as.this).inflate(R.layout.fill_all, viewGroup, false);
        ...
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!exam[Subjects - 2].getText().toString().isEmpty() && !exam[Subjects - 2].getText().toString().isEmpty()) {
                    exam_sport = String.valueOf(exam[Subjects - 2].getText());
                }
                if (!test1[Subjects - 2].getText().toString().isEmpty() && !test1[Subjects - 2].getText().toString().isEmpty()) {
                    test1_sport = String.valueOf(test1[Subjects - 2].getText());
                }
                if (!test2[Subjects - 2].getText().toString().isEmpty() && !test2[Subjects - 2].getText().toString().isEmpty()) {
                    test2_sport = String.valueOf(test2[Subjects - 2].getText());
                }
                if (!ta9wim[Subjects - 2].getText().toString().isEmpty() && !ta9wim[Subjects - 2].getText().toString().isEmpty()) {
                ...
                for(int i = 0; i<SUBJECTS; i++){
                    ...
                    if(!(application[i] == null)){
                        ...
                        if(!TextUtils.isEmpty(application[i].getText().toString()) && !application[i].getText().toString().equals(".")){
                            ...
                            Log.d("d","d");
                            alerdialog.show();
                            SUBJECTS = 11; success = false; break;
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("science_3as", MODE_PRIVATE);
