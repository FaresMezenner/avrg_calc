...
public class Bac_math extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_math.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_math.this).inflate(R.layout.save_before, viewGroup, false);
  ...
  @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bac_math);
        ...
        SharedPreferences prefs = getSharedPreferences("bac_math", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Bac_math.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Bac_math.this).inflate(R.layout.repport_bac, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_math.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_math.this).inflate(R.layout.fill_all, viewGroup, false);
