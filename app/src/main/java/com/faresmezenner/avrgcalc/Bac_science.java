...
public class Bac_science extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_science.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_science.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bac_science);
        ...
        SharedPreferences prefs = getSharedPreferences("bac_science", MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();


        EditText[] note = new EditText[11];

        note[0] = findViewById(R.id.exam_arabic);
        note[1] = findViewById(R.id.exam_math);
        note[2] = findViewById(R.id.exam_physic);
        note[3] = findViewById(R.id.exam_science);
        note[4] = findViewById(R.id.exam_islamia);
        note[5] = findViewById(R.id.exam_history);
        note[6] = findViewById(R.id.exam_french);
        note[7] = findViewById(R.id.exam_english);
        note[8] = findViewById(R.id.exam_philo);
        note[9] = findViewById(R.id.exam_sport);
        note[10] = findViewById(R.id.exam_kabyle);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Bac_science.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Bac_science.this).inflate(R.layout.repport_bac, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Bac_science.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Bac_science.this).inflate(R.layout.fill_all, viewGroup, false);
