...
public class Lettre_jd extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Lettre_jd.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Lettre_jd.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lettre_jd);
        ...
        application[9] = null;
        application[10] = findViewById(R.id.test2_kabyle);
        ...
        SharedPreferences prefs = getSharedPreferences("lettre_jd", MODE_PRIVATE);
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Lettre_jd.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Lettre_jd.this).inflate(R.layout.repport_lettre_jd, viewGroup2, false);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Lettre_jd.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Lettre_jd.this).inflate(R.layout.fill_all, viewGroup, false);
