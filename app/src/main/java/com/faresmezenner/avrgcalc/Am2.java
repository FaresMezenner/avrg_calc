...
public class Am2 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Am2.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Am2.this).inflate(R.layout.save_before, viewGroup, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder alertBuilder2 = new AlertDialog.Builder(Am2.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup2 = findViewById(android.R.id.content);
        View dialogView2 = LayoutInflater.from(Am2.this).inflate(R.layout.repport_cem, viewGroup2, false);
        ...
        CheckBox[] checkboxs = new CheckBox[14];
        String[] checkboxs_keys = new String[14];


        EditText[] test2 = new EditText[14];
        EditText[] exam = new EditText[14];
        EditText[] test1 = new EditText[14];
        EditText[] ta9wim = new EditText[14];
        ...
        checkboxs[9] = findViewById(R.id.test2_informatique_checkbox);
        checkboxs[10] = findViewById(R.id.test2_sport_checkbox);
        checkboxs[11] = findViewById(R.id.test2_art_checkbox);
        checkboxs[12] = findViewById(R.id.test2_music_checkbox);
        checkboxs[13] = findViewById(R.id.test2_kabyle_checkbox);
        ...
        checkboxs_keys[9] = "test2_informatique";
        checkboxs_keys[10] = "test2_sport";
        checkboxs_keys[11] = "test2_art";
        checkboxs_keys[12] = "test2_music";
        checkboxs_keys[13] = "test2_kabyle";
        ...
        exam[9] = findViewById(R.id.exam_informatique);
        exam[10] = findViewById(R.id.exam_sport);
        exam[11] = findViewById(R.id.exam_art);
        exam[12] = findViewById(R.id.exam_music);
        exam[13] = findViewById(R.id.exam_kabyle);
        ...
        test2[9] = findViewById(R.id.test2_informatique);
        test2[10] = findViewById(R.id.test2_sport);
        test2[11] = findViewById(R.id.test2_art);
        test2[12] = findViewById(R.id.test2_music);
        test2[13] = findViewById(R.id.test2_kabyle);
        ...
        test1[9] = findViewById(R.id.test1_informatique);
        test1[10] = findViewById(R.id.test1_sport);
        test1[11] = findViewById(R.id.test1_art);
        test1[12] = findViewById(R.id.test1_music);
        test1[13] = findViewById(R.id.test1_kabyle);
        ...
        ta9wim[9] = findViewById(R.id.ta9wim_informatique);
        ta9wim[10] = findViewById(R.id.ta9wim_sport);
        ta9wim[11] = findViewById(R.id.ta9wim_art);
        ta9wim[12] = findViewById(R.id.ta9wim_music);
        ta9wim[13] = findViewById(R.id.ta9wim_kabyle);
        ...
        SharedPreferences prefs = getSharedPreferences("am2", MODE_PRIVATE);
        ...
        checkboxs[13].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {

                if(!isChecked){
                    blockInput(test2[13], editor, checkboxs_keys[13]);
                } else {
                    allowInput(prefs, 13,test2[13], editor, checkboxs_keys[13]);
                }
            }
        });


        TextView[] avrgs_show = new TextView[14];
        ...
        avrgs_show[9] = dialogView2.findViewById(R.id.informatique_avrg);
        avrgs_show[10] = dialogView2.findViewById(R.id.sport_avrg);
        avrgs_show[11] = dialogView2.findViewById(R.id.art_avrg);
        avrgs_show[12] = dialogView2.findViewById(R.id.music_avrg);
        avrgs_show[13] = dialogView2.findViewById(R.id.kabyle_avrg);
        ...
        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Am2.this,R.style.CustomAlertDialog);
        ViewGroup viewGroup = findViewById(android.R.id.content);
        View dialogView = LayoutInflater.from(Am2.this).inflate(R.layout.fill_all, viewGroup, false);
    ...
    void allowInput(SharedPreferences prefs, int num, EditText editText, SharedPreferences.Editor editor, String checkbox_key){
        SharedPreferences prefs1 = getSharedPreferences("am2", MODE_PRIVATE);
